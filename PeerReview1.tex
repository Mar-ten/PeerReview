...
The test method for ASTM D6272-17 is not being replicated in this experiment as claimed. The mentioning of this standard should be left out of the manuscript. The notation $N$ was double used, once to describe number of plies and secondly for normal forces. Equation 3 seems to be unnecessary and might be better stated as a conditional exception.
